...
QtObject {
    // Unified display names (replaces separate mod + special maps)
    readonly property var displayNames: ({
        ...
        // Special keys
        "Escape":"Escape", "Space":"Space", "Enter":"Enter", "Tab":"Tab",
        "BackSpace":"Backspace", "Delete":"Delete", "Insert":"Insert",
        "Home":"Home", "End":"End", "PageUp":"Page Up", "PageDown":"Page Down",
        "Up":"Arrow Up", "Down":"Arrow Down", "Left":"Arrow Left", "Right":"Arrow Right",
        "ContextMenu":"Context Menu", "PrintScreen":"Print Screen", "PauseBreak":"Pause/Break",
        "ScrollLock":"Scroll Lock", "NumLock":"Num Lock",
        // Punctuation
        "quote":"'", "comma":",", "dash":"-", "dot":".", "slash":"/",
        "semicolon":";", "equal":"=", "leftbracket":"[", "backslash":"\\",
        "rightbracket":"]", "backtick":"`", "hash":"#",
        // Media / scroll
        "PlayPause":"Play/Pause", "VolumeUp":"Volume Up", "VolumeDown":"Volume Down",
        "Mute":"Mute", "Next":"Next Track", "Previous":"Previous Track",
        "scrollup":"Scroll Up", "scrolldown":"Scroll Down"
    })

    // Combo box actions list
    ...
    // Cached Qt key → rivalcfg key map (built once on first access)
    readonly property var _keyMap: {
        var m = {}
        m[Qt.Key_Shift]="Shift"; m[Qt.Key_Control]="Ctrl"; m[Qt.Key_Alt]="Alt"
        m[Qt.Key_Meta]="LeftSuper"; m[Qt.Key_AltGr]="RightAlt"
        m[Qt.Key_Super_L]="LeftSuper"; m[Qt.Key_Super_R]="RightSuper"
        m[Qt.Key_Menu]="ContextMenu"; m[Qt.Key_Escape]="Escape"; m[Qt.Key_Space]="Space"
        m[Qt.Key_Return]="Enter"; m[Qt.Key_Enter]="Enter"; m[Qt.Key_Tab]="Tab"
        m[Qt.Key_Backspace]="BackSpace"; m[Qt.Key_Delete]="Delete"; m[Qt.Key_Insert]="Insert"
        m[Qt.Key_Home]="Home"; m[Qt.Key_End]="End"; m[Qt.Key_PageUp]="PageUp"
        m[Qt.Key_PageDown]="PageDown"; m[Qt.Key_CapsLock]="CapsLock"; m[Qt.Key_NumLock]="NumLock"
        m[Qt.Key_ScrollLock]="ScrollLock"; m[Qt.Key_Pause]="PauseBreak"; m[Qt.Key_Print]="PrintScreen"
        m[Qt.Key_Left]="Left"; m[Qt.Key_Right]="Right"; m[Qt.Key_Up]="Up"; m[Qt.Key_Down]="Down"
        for (var i = 1; i <= 12; i++) m[Qt["Key_F" + i]] = "F" + i
        m[Qt.Key_Apostrophe]="quote"; m[Qt.Key_Comma]="comma"; m[Qt.Key_Minus]="dash"
        m[Qt.Key_Period]="dot"; m[Qt.Key_Slash]="slash"; m[Qt.Key_Semicolon]="semicolon"
        m[Qt.Key_Equal]="equal"; m[Qt.Key_BracketLeft]="leftbracket"
        m[Qt.Key_Backslash]="backslash"; m[Qt.Key_BracketRight]="rightbracket"
        m[Qt.Key_QuoteLeft]="backtick"; m[Qt.Key_NumberSign]="hash"
        return m
    }
    ...
    function getActionDisplay(a) {
        ...
        if (a.length === 1 && /^[A-Z0-9]$/.test(a)) return a + " key"
        if (displayNames[a]) return displayNames[a]
        if (/^F\d+$/.test(a)) return a + " key"
        return a || "Unknown"
    }

    function getDefaultAction(b) { return b.toLowerCase() === "button6" ? "dpi" : b.toLowerCase() }
